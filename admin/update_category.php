...
if (isset ($_GET["uuid"])) {
    $uuid = $_GET["uuid"];
    $query = "SELECT * FROM tlbl_category_product WHERE uuid = :uuid";
    $execute_request = $connexion->prepare($query);
    $execute_request->bindParam(":uuid", $uuid);
    $execute_request->execute();
    $category = $execute_request->fetch(PDO::FETCH_ASSOC);
...
<div class="body-wrapper-inner">
    <div class="container-fluid mt-3 pb-5">
        ...
        <div class="col-lg-12 col-sm-12 mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="mb-0">
                    <h2 class="text-uppercase fw-bold">Modifier une categorie  </h2>
                </div>
    ...
    <?php include("process_update_category.php"); ?>
    <?php if ($error): ?>
                ...
                <form class="needs-validation" action="" novalidate method="post">
                     ...
                     <div class="row">
                        <div class="col-lg-6 col-sm-12 mb-3">
                            ...
                            <input type="hidden" value="<?= $category["uuid"]?>" name="uuid" class="form-control" required>
                     ...
                     <div class="col-12">
                        <button class="btn btn-primary rounded-0" name="update_category" type="submit">Modifier</button>
                    </div>
                </form>
            </div>
        </div>
